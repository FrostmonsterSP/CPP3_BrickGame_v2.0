/**
 * @file brick.h
 * @brief Библиотека для управления игровым процессом из проекта C7_BrickGame_v1.0
 *
 * @details Библиотека brick.h предназначена для управления игровым процессом.
 ...
 * Подробная информация в документации: @link https://sharlabr-projects.su/C7_BrickGame_S21/doc/
 * 
 */
#ifndef ENGINE_H
#define ENGINE_H
